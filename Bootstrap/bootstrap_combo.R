...
for (run in 1:datasets) {
  ...
  for (boot in 1:bootstraps) {
    ...
    bs_list_ewa[[run]][,,boot] = readMat(paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/bootstrap_cor_ewa/cor_ewa_bs_", 
                                        boot, "sim_", sim_num, ".mat"))[[1]]
    bs_list_eh[[run]][,,boot]  = readMat(paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/bootstrap_cor_eh/cor_eh_bs_",  
                                        boot, "sim_", sim_num, ".mat"))[[1]]
    }
    }
...
# 25th, mean, and 75th percentile matrices (3 lists) for EWA and mean EH
...
save(bs_list_mean_h,    file = "/ifs/scratch/msph/ehs/eag2186/npbnmf/bootstrap_cor/bs_list_eh.RDA")
