...
for (boot in 1:bootstraps) {
  if (file.exists(paste0("./bootstrap/output/bsci_out/ewa_bs_sim_", set, "_bs_", boot, ".mat"))) {
    ...
    bs_pred[,,boot] = readMat(paste0("./bootstrap/output/bsci_out/pred_bs_sim_", set, "_bs_", boot, ".mat"))[[1]]
  }
