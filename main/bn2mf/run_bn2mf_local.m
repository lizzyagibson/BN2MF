...
addpath '/Users/lizzy/BN2MF/functions'

j = 1;

    simdata1 = readtable(strcat("/Users/lizzy/BN2MF/sims/csvs/sim_sep_", num2str(j), ".csv"));
    patterns = readtable(strcat("/Users/lizzy/BN2MF/sims/csvs/patterns_sep_", num2str(j), ".csv"));
    scores   = readtable(strcat("/Users/lizzy/BN2MF/sims/csvs/scores_sep_", num2str(j), ".csv"));
    ...
    % Save matrices
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/ewa_NOTscaled", num2str(j), ".mat"), 'EWA');
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/eh_NOTscaled",  num2str(j), ".mat"), 'EH');

    % Save scaled versions, too
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/ewa_scaled", num2str(j), ".mat"), 'EWA_scaled');
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/eh_scaled",  num2str(j), ".mat"), 'EH_scaled');

    % CI are for scaled WA and norm H
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/upperWA_", num2str(j), ".mat"), 'upper_ci_WA');
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/lowerWA_", num2str(j), ".mat"), 'lower_ci_WA');

    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/upperH_", num2str(j), ".mat"), 'upper_ci_H');
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/lowerH_", num2str(j), ".mat"), 'lower_ci_H');

    % Save variational distribution arrays, too
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/distWA_", num2str(j), ".mat"), 'WA_scaled');
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/distEH_", num2str(j), ".mat"), 'H_scaled');

    % Save pred
    save(strcat("/Users/lizzy/BN2MF/main/bn2mf/output/pred_", num2str(j), ".mat"), 'pred');
