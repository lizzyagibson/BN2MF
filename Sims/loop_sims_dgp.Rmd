...
```{r} 
sim_dgp_local <- rbind(sim_dist %>% mutate(data = "Distinct"),
      sim_over %>% mutate(data = "Overlapping"))
  
sim_dgp_local

# for (i in 1:nrow(sim_dgp_local)) {
#   write_csv(as_tibble(sim_dgp_local$sim[[i]]), paste0("./Sims/dgp_local/sim_dgp_local_", i, ".csv"))
# }

# save(sim_dgp_local, file = "./Sims/sim_dgp_local.RDA")
```
