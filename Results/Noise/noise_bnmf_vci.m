...
% Import the data
simdata1 = readtable(strcat("/ifs/scratch/msph/ehs/eag2186/Data/noise_csv/sim_noise_", j, ".csv"));
patterns = readtable(strcat("/ifs/scratch/msph/ehs/eag2186/Data/noise_csv/patterns_noise_", j, ".csv"));
scores   = readtable(strcat("/ifs/scratch/msph/ehs/eag2186/Data/noise_csv/scores_noise_",   j, ".csv"));
...
% Save matrices
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_ewa_NOTscaled", j, ".mat"), 'EWA');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_eh_NOTscaled",  j, ".mat"), 'EH');

% Save scaled versions, too
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_ewa_scaled", j, ".mat"), 'EWA_scaled');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_eh_scaled",  j, ".mat"), 'EH_scaled');

% CI are for scaled WA and norm H
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_upperWA_", j, ".mat"), 'upper_ci_WA');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_lowerWA_", j, ".mat"), 'lower_ci_WA');

save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_upperH_", j, ".mat"), 'upper_ci_H');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_lowerH_", j, ".mat"), 'lower_ci_H');

% Save variational distribution arrays, too
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_distWA_", j, ".mat"), 'WA_scaled');
save(strcat("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_vci_out/noise_distEH_", j, ".mat"), 'H_scaled');

% Results go into `combine_noise.R`