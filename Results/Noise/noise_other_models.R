...
# Read in Sims
load("/ifs/scratch/msph/ehs/eag2186/Data/sim_noise.RDA")
...
save(noise_out, file = paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/noise/noise_other_models_out/noise_out_", job_num, ".RDA"))
