...
```{r}
nmf_1 <- nmf(edc_cc, rank = 1, nrun = 100, method = "lee")
nmf_2 <- nmf(edc_cc, rank = 2, nrun = 100, method = "lee")
nmf_3 <- nmf(edc_std, rank = 3, nrun = 100, method = "brunet")
nmf_4 <- nmf(edc_cc, rank = 4, nrun = 100, method = "lee")
nmf_5 <- nmf(edc_cc, rank = 5, nrun = 100, method = "lee")
nmf_6 <- nmf(edc_cc, rank = 6, nrun = 100, method = "lee")
