...
create_scores <- function (seed) {
  set.seed(seed)
  scores <- matrix(exp(rnorm(1000*4, mean = 1)), ncol = 4)
...
# for (i in 1:nrow(sim_sep_m1)) {
#   write_csv(as_tibble(sim_sep_m1$sim[[i]]),           paste0("./Sims/Sep/sim_m1_", i, ".csv"))
#   write_csv(as_tibble(sim_sep_m1$chem[[i]]),          paste0("./Sims/Sep/chem_m1_", i, ".csv"))
#   write_csv(as_tibble(sim_sep_m1$true_patterns[[i]]), paste0("./Sims/Sep/patterns_m1_", i, ".csv"))
#   write_csv(as_tibble(sim_sep_m1$true_scores[[i]]),   paste0("./Sims/Sep/scores_m1_", i, ".csv"))
# }

# save(sim_sep_m1, file = "./Sims/sim_sep_m1_grid.RDA")
```
