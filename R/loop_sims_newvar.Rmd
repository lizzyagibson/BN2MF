...
for (i in 1:100) {
  write_csv(as_tibble(sim_cor_100[i,4][[1]][[1]]), paste0("./R/Sims/Iterate/sim_cor_100_", i, "_stand.csv"))
}
```
...
for (i in 1:100) {
  write_csv(as_tibble(sim_over_100[i,4][[1]][[1]]), paste0("./R/Sims/Iterate/sim_over_100_", i, "_stand.csv"))
}
```
