...
# Files to do
#load("/ifs/scratch/msph/ehs/eag2186/npbnmf/to_do_dim.RDA")
#if (!(job_num %in% to_do)) {quit("no")}
...
load(paste0("/ifs/scratch/msph/ehs/eag2186/npbnmf/dim_out/dim_out_", job_num, ".RDA"))
