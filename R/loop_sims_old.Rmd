...
```{r}
# save(sim_dist, file = "./R/Sims/Iterate/sim_dist_old.RDA")

# for (i in 1:100) {
#   write_csv(as_tibble(sim_dist[i,4][[1]][[1]]), paste0("./R/Sims/Iterate/sim_dist_", i, ".csv"))
# }
```
...
```{r}
# save(sim_cor, file = "./R/Sims/Iterate/sim_cor_old.RDA")

# for (i in 1:100) {
#   write_csv(as_tibble(sim_dist[i,4][[1]][[1]]), paste0("./R/Sims/Iterate/sim_cor_", i, ".csv"))
# }
```
...
```{r}
# save(sim_over, file = "./R/Sims/Iterate/sim_over_old.RDA")

# for (i in 1:100) {
#   write_csv(as_tibble(sim_dist[i,4][[1]][[1]]), paste0("./R/Sims/Iterate/sim_over_", i, ".csv"))
# }
```
