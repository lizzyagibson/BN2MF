...
```{r}
nmf_2 <- nmf(edc_std, rank = 2, nrun = 10)
nmf_3 <- nmf(edc_std, rank = 3, nrun = 10)
nmf_4 <- nmf(edc_std, rank = 4, nrun = 10)
nmf_5 <- nmf(edc_std, rank = 5, nrun = 10)
nmf_6 <- nmf(edc_std, rank = 6, nrun = 10)
