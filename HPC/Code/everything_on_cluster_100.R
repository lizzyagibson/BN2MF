...
# Read in Sims
load("Data/sim_dist_100.RDA")
load("Data/sim_cor_100.RDA")
load("Data/sim_over_100.RDA")
...
out_dist_100 <- out_dist_un %>% dplyr::select(-grep("_un|_out", colnames(.)))
out_over_100 <- out_over_un %>% dplyr::select(-grep("_un|_out", colnames(.)))
out_cor_100 <- out_cor_un %>% dplyr::select(-grep("_un|_out", colnames(.)))

save(out_dist_100, file = paste0("out_", job_num, "_dist_100.RDA"))
save(out_over_100, file = paste0("out_", job_num, "_over_100.RDA"))
save(out_cor_100, file = paste0("out_", job_num, "_cor_100.RDA"))
